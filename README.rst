...
**Note:** Networks on both CPU and GPU (CUDA) can be visualized. Moreover there is no need of transfering data between CPU and GPU for visualization on GPU networks (except plots).
